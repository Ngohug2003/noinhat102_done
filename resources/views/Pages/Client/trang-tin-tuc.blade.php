              ...
              <div class="col-6 col-lg-4 mb-4">
                <div class="post-box">
                    <div class="post-image mb-3">
                        <a href="{{ route('Client.postShow', ['id' => $post->id]) }}"><img src="{{ asset('images/' . $post->image) }}" alt="{{$post->name}}"></a>
                    </div>
                    <h3 class="post-title size18 fw-700"><a href="{{ route('Client.postShow', ['id' => $post->id]) }}">{{$post->name}}</a> </h3>
                </div>
            </div>
              @endforeach
